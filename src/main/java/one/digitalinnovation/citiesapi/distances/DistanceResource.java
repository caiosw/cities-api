package one.digitalinnovation.citiesapi.distances;

import one.digitalinnovation.citiesapi.distances.service.DistanceService;
...
public class DistanceResource {
  ...
  @GetMapping("/by-cube")
  private ResponseEntity byCube(@RequestParam(name = "from") final Long city1, @RequestParam(name = "to") final Long city2) {
    log.info("byCube");
